...
namespace Kuvio.Kernel.AspNet.Blazor.BlobTransfer
{
    ...
    internal class RemoteBlobStream : BlobStream
    {
        ...
        public RemoteBlobStream(IJSRuntime jsRuntime, BlobImpl file, int maxMessageSize, int maxBufferSize)
            : base(jsRuntime, file)
        {
